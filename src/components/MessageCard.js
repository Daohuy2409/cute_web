...
const messages = [
  "Chúc các bạn nữ một ngày tràn ngập niềm vui, hạnh phúc và yêu thương! 💖 ",
  "Mong rằng mỗi ngày đều mang đến cho các bạn nhiều may mắn, nụ cười và những điều tuyệt vời nhất.",
  "Hãy luôn xinh đẹp, tự tin và tỏa sáng theo cách riêng của mình! ✨",
  "Chúc các bạn gặt hái được nhiều thành công và luôn tràn đầy năng lượng tích cực. Chúc một ngày 8/3 ý nghĩa và đáng nhớ! 🌷💫"
];
